...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        //1.yol
        StringBuilder sb1=new StringBuilder();//default capacity 16 bit olan value su olmayan boş string

        System.out.println("sb1.length() = " + sb1.length());//0 ->length(): sb deki karakter sayası return eder
