...
public class C05_ZonedDateTime {
    public static void main(String[] args) {
        ...
        LocalDate trhZone = LocalDate.now(ZoneId.of("America/New_York"));//amerika newyork localinin anlık tarih bilgisi tanımlandı
       ...
       // ZonedDateTime zdt3=ZonedDateTime.now(ZoneId.of("America"));//RTE -> yerel saat dilimide tanımlanmalı
