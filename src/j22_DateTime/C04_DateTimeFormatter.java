...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd//MMMM//YY");//istediğimiz gibi formatı yapabiliriz
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//25//Ekim//22

        DateTimeFormatter dtf1 = DateTimeFormatter.ofPattern("hh:mm:ss a");//saat dakika saniye am format tanımlandı
        System.out.println("dtf1.format() = " + dtf1.format(ldt));
/*
         format->
         GUN
