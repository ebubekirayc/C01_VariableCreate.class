...
public class C01_LocalDate {
    ...
    public static void main(String[] args) {
        ...
        LocalDate bugun=LocalDate.now();// systemden bugunün yılay gün değerini atama yapar

        System.out.println(bugun);//2022-10-25
        ...
        System.out.println("date1.plusWeeks(12) = " + date1.plusWeeks(12));
