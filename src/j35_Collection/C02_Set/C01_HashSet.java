...
/*
    ...
    */
        ...
        HashSet<String> hs1 = new HashSet<>(Arrays.asList("Ercan", "Yakup", "Adem", "Rukiye", "Nur"));//eleman ataması yapılan bir hasste
        ...
        HashSet<String> hs2 = new HashSet<>(Arrays.asList("Basarı","Gayrete","Aşıktır"));
        ...
        System.out.println("hs2.contains(\"javaNAZZ\") = " + hs2.contains("javaNAZZ"));
