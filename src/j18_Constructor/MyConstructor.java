...
public class MyConstructor

     {
        ...
        public MyConstructor(int i ){
            this();//p'iz consi call edildi
            this.y = i;// cons. parametresi i değeri  ins. variable y'ye atandı
            x+=y;//inst. y değeri ins. x değerine atandı
            System.out.println("-x"+x);

        }

        public MyConstructor(int i, int i2) {
            this(3);// int p'li consc  parametre 3 olarak call edildi
