...
public class C3_replaceAll_fill {
 ...
 //replaceAll();> listte belirli bir elemanı belirli bir değer ile update eder
        ...
        System.out.println("listSayi = " + listSayi);//listSayi öncesi->[1, 24, 23, 14, 19, 60, 1, 55, 27, 1, 38]


        Collections.replaceAll(listSayi, 1,20); //listSayi inde 1 yerine 20 değeri atandı
